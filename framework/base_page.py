...
class BasePage(object):
    ...
    def text(self, selector):
        el = self.find_element(selector)
        logger.info(" Current elements value is %s" % el.text)
        return el.text
    ...
    def get_drop_down_list(self):
        m = self.driver.find_element_by_xpath(".//*[@id='app']/div/div[3]/div/div[2]/div[2]/div[2]/div/form/div[2]/div/div/div[1]/input")
    ...
    def sleep(seconds):
        ...
        # 显示等待
    def wait_time(self,seconds,selector):
        WebDriverWait(self.driver, seconds, 0.5).until(self.find_element(selector))
